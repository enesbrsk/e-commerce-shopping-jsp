...
<%@ page import="com.example.ecommerceshopping.model.User" %>
<%@ page import="com.example.ecommerceshopping.model.Cart" %>
<%@ page import="com.example.ecommerceshopping.dao.ProductDao" %>
